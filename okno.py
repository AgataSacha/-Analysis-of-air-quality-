...
class ctkApp:
    def __init__(self):
        ...
        self.button = ctk.CTkButton(master = self.app, text = "Wyświetl wykres", command = self.show_plot) #jeżeli użytkownik wciśnie ten przycisk, to uruchomi się funkcja show_plot
    ...
    def show_plot(self): #wykres wyłącznie poglądowy (wykresy będziemy brać z pliku analiza_danych.py)
        fig, ax = plt.subplots()
